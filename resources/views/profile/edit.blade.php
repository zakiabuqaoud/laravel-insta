                    ...
                    <div class="col-lg-3">
                        <div class="acc-leftbar">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="true"><i class="la la-cogs"></i>Profile</a>
                                ...
                                <div class="acc-setting">
                                    ...
                                    <form action="{{ route('profile.update') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="cp-field">
                                            <h5>Hour Rate</h5>
                                            <div class="cpp-fiel">
                                                <input type="text" name="hour_rate" value="{{ old('hour_rate', $profile->hour_rate) }}" placeholder="Hour Rate">
                                        ...
                                        <div class="cp-field">
                                            <h5>Bio</h5>
                                            <div class="cpp-fiel">
                                                <input type="text" name="bio" value="{{ old('bio', $profile->bio) }}" placeholder="Bio">
                                                <i class="fa fa-lock"></i>
                                            </div>
                                        </div>
                                        <div class="cp-field">
